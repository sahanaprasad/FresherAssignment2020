...
public class connectionClass {
    ...
    public void create() throws ClassNotFoundException
    {
        ...
        try {
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/assignmnet","root","root@123");
    ...
    public void insert(String name, int quantity, float price, String type) {
        ...
        try{
            Connection conn =   DriverManager.getConnection("jdbc:mysql://localhost:3306/db_test?useSSl=false","root","root@123");
