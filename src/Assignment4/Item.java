...
public class Item {
    ...
    public Item(String name, String type, float price, int quantity) {
    ...
    public Item(String name, String type, double price, double quantity, double tax) {
        this.name = name;
        this.type = type;
        this.price = price;
    ...
    public void setTax() {
        this.tax =calculateTax(this.type, this.price);
    }
